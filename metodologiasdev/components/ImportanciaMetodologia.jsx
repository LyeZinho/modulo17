  ...
  return (
    <div className="min-h-full flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 ">
      ...
      <h7>
        ...
        desenvolvimento de software e ajudam a garantir que todas as etapas
        necessárias sejam tomadas durante o processo de desenvolvimento. 
        <br />
        Além
        disso, metodologias e ferramentas de análise podem ajudar a identificar
        possíveis problemas no início do processo de desenvolvimento, o que pode
        economizar tempo e dinheiro posteriormente. Existem muitas metodologias
        de desenvolvimento de software diferentes disponíveis, e cada uma tem
        seus próprios pontos fortes e fracos. 
        <br />
        É importante seleccionar a
        metodologia que melhor se adapta às necessidades do projecto em questão.
        Além disso, diferentes ferramentas de análise podem ser usadas para
