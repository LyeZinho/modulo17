...
const ImportanciaMetodologia = () => {
  return (
    <div className="min-h-full flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 ">
      <div className="flex flex-row items-left justify-left mt-6 space-x-10 pb-8 pt-8">
        <div className="flex pt-6">
          <h2>Importância das Metodologia de Desenvolvimento</h2>
          <h7>
            Metodologias e ferramentas de análise são importantes no
            desenvolvimento de produtos de software porque fornecem uma abordagem
            estruturada para o desenvolvimento de software e ajudam a garantir que
            todas as etapas necessárias sejam tomadas durante o processo de
            desenvolvimento.
            <br />
            ...
            software diferentes disponíveis, e cada uma tem seus próprios pontos
            fortes e fracos.
            <br />É importante seleccionar a metodologia que melhor se adapta às
            necessidades do projecto em questão. Além disso, diferentes
            ferramentas de análise podem ser usadas para ajudar a avaliar a
            viabilidade de um projecto, identificar riscos potenciais e acompanhar
            o progresso durante o desenvolvimento.
          </h7>
        </div>
        <div className="flex pt-6">
          <Image
